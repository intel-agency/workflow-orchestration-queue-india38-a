...
>
> **Scope:** Template repo `workflow-orchestration-queue-india38-a` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
